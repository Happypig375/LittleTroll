...
Namespace YouAreAnIdiot
    ...
    Public Class HAHA
        ...
        Private Sub InitializeComponent()
            ...
            Me.Label1.Font = New Font("Verdana", 12!)
            ...
            Me.Label2.Font = New Font("Verdana", 12!)
            ...
            Me.MoveX.Font = New Font("Verdana", 12!)
            ...
            Me.MoveY.Font = New Font("Verdana", 12!)
            ...
            Me.MoveY.Text = "1"
            Me.Y.AutoSize = True
            Me.Y.Font = New Font("Verdana", 12!, FontStyle.Regular, GraphicsUnit.Point, 0)
        ...
        Private Sub Timer1_Tick(ByVal sender As Object, ByVal e As EventArgs)
            ...
            If (Conversions.ToDouble(Me.X.Text) >= num3) Then
                Me.MoveX.Text = Conversions.ToString(CInt((0 - ((1 + CInt(Math.Round(CDbl((34! * VBMath.Rnd))))) * 1))))
                If (Conversions.ToDouble(Me.MoveY.Text) < 0) Then
                    Me.MoveY.Text = Conversions.ToString(CInt((0 - ((1 + CInt(Math.Round(CDbl((34! * VBMath.Rnd))))) * 1))))
                ElseIf (Conversions.ToDouble(Me.MoveY.Text) > 0) Then
                    Me.MoveY.Text = Conversions.ToString(CInt(((1 + CInt(Math.Round(CDbl((34! * VBMath.Rnd))))) * 1)))
                End If
            End If
            If (Conversions.ToDouble(Me.Y.Text) >= (height - Me.Height)) Then
                ...
                ElseIf (Conversions.ToDouble(Me.MoveX.Text) > 0) Then
                    Me.MoveX.Text = Conversions.ToString(CInt(((1 + CInt(Math.Round(CDbl((34! * VBMath.Rnd))))) * 1)))
                End If
            End If
