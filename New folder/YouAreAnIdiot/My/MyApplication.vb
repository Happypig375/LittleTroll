...
Namespace YouAreAnIdiot.My
    ...
    Friend Class MyApplication
        ...
        <MethodImpl((MethodImplOptions.NoOptimization Or MethodImplOptions.NoInlining)), DebuggerHidden, EditorBrowsable(EditorBrowsableState.Advanced), STAThread> _
        ...
        Protected Overrides Sub OnCreateMainForm()
            Me.MainForm = MyProject.Forms.Question
        End Sub
