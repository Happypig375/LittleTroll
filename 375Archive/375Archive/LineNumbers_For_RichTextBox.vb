    ...
    Protected Overrides Sub OnPaint(ByVal e As System.Windows.Forms.PaintEventArgs)
        ...
        If zLNIs.Count > 0 Then
            ...
            For zA As Integer = 0 To zLNIs.Count - 1
                ...
                If zGridLines_Show = True Then
                    ...
                    zGP_GridLines.AddRectangle(New Rectangle(CInt(-zGridLines_Thickness), zLNIs(zA).Rectangle.Y, CInt(Me.Width + zGridLines_Thickness * 2), CInt(Me.Height - zLNIs(0).Rectangle.Y + zGridLines_Thickness)))
                ...
                If zLineNumbers_Show = True Then
                    ...
                    Select Case zLineNumbers_Alignment
                        ...
                        Case ContentAlignment.MiddleLeft
                            zPoint = New Point(zLNIs(zA).Rectangle.Left + Me.Padding.Left + zLineNumbers_Offset.Width, CInt(zLNIs(zA).Rectangle.Top + (zLNIs(zA).Rectangle.Height / 2) + zLineNumbers_Offset.Height - zTextSize.Height / 2))
                        Case ContentAlignment.BottomLeft
                            zPoint = New Point(zLNIs(zA).Rectangle.Left + Me.Padding.Left + zLineNumbers_Offset.Width, CInt(zLNIs(zA).Rectangle.Bottom - Me.Padding.Bottom + 1 + zLineNumbers_Offset.Height - zTextSize.Height))
                        Case ContentAlignment.TopCenter
                            zPoint = New Point(CInt(zLNIs(zA).Rectangle.Width / 2 + zLineNumbers_Offset.Width - zTextSize.Width / 2), zLNIs(zA).Rectangle.Top + Me.Padding.Top + zLineNumbers_Offset.Height)
                        ...
                        Case ContentAlignment.TopRight
                            zPoint = New Point(CInt(zLNIs(zA).Rectangle.Right - Me.Padding.Right + zLineNumbers_Offset.Width - zTextSize.Width), zLNIs(zA).Rectangle.Top + Me.Padding.Top + zLineNumbers_Offset.Height)
        ...
        If zMarginLines_Show = True AndAlso zMarginLines_Side > LineNumberDockSide.None Then
            ...
            If zMarginLines_Side = LineNumberDockSide.Left Or zMarginLines_Side = LineNumberDockSide.Height Then
                e.Graphics.DrawLine(zPen, New Point(CInt(Math.Floor(zMarginLines_Thickness / 2)), 0), New Point(CInt(Math.Floor(zMarginLines_Thickness / 2)), Me.Height - 1))
            ...
            If zMarginLines_Side = LineNumberDockSide.Right Or zMarginLines_Side = LineNumberDockSide.Height Then
                e.Graphics.DrawLine(zPen, New Point(CInt(Me.Width - Math.Ceiling(zMarginLines_Thickness / 2)), 0), New Point(CInt(Me.Width - Math.Ceiling(zMarginLines_Thickness / 2)), Me.Height - 1))
