...
Namespace Gma.System.MouseKeyHook.WinApi
	Friend NotInheritable Class HotkeysNativeMethods
		Private Sub New()
		End Sub
		''' <summary>
		...
		Public Shared Function RegisterHotKey(hwnd As IntPtr, id As Integer, fsModifiers As Integer, vk As Integer) As Integer
		End Function
