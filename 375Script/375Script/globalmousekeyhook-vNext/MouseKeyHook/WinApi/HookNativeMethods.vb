...
Namespace Gma.System.MouseKeyHook.WinApi
	Friend NotInheritable Class HookNativeMethods
		Private Sub New()
		End Sub
		''' <summary>
		...
		Friend Shared Function CallNextHookEx(idHook As IntPtr, nCode As Integer, wParam As IntPtr, lParam As IntPtr) As IntPtr
		End Function
		...
		Friend Shared Function SetWindowsHookEx(idHook As Integer, lpfn As HookProcedure, hMod As IntPtr, dwThreadId As Integer) As HookProcedureHandle
		End Function
		...
		''' </remarks>
		<DllImport("user32.dll", CharSet := CharSet.Auto, CallingConvention := CallingConvention.StdCall, SetLastError := True)> _
		Friend Shared Function UnhookWindowsHookEx(idHook As IntPtr) As Integer
		End Function
	End Class
End Namespace
